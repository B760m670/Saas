...
let package = Package(
    name: "AtlasCore",
    // Нижняя граница — та же, что у приложения: iOS 15, ровно как
    // требует LiveContainer. Объявлено явно, чтобы расхождение с целью
    // сборки ловил компилятор, а не устройство.
